...
def get_query_specification(breakdowns: Optional[Sequence[str]] = None,
                            ...
                            havings: Optional[Sequence[pulumi.InputType['GetQuerySpecificationHavingArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetQuerySpecificationHavingArgs']] havings: Zero or more filters used to restrict returned groups in the query result.
...
def get_query_specification_output(breakdowns: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                   ...
                                   havings: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetQuerySpecificationHavingArgs']]]]] = None,
