...
class CreateFundingSourceForBenefactorWithPlaidTokenRequest(object):
    ...
    def __init__(self, beneficiary_uuid=None, plaid_public_token=None, account_id=None):  # noqa: E501
    ...
    def beneficiary_uuid(self):
        """Gets the beneficiary_uuid of this CreateFundingSourceForBenefactorWithPlaidTokenRequest.  # noqa: E501

        Unique identifier generated by Rightfoot for Benefactor. If not provided, organizationUuid must be set.   # noqa: E501

        :return: The beneficiary_uuid of this CreateFundingSourceForBenefactorWithPlaidTokenRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def beneficiary_uuid(self, beneficiary_uuid):
        """Sets the beneficiary_uuid of this CreateFundingSourceForBenefactorWithPlaidTokenRequest.

        Unique identifier generated by Rightfoot for Benefactor. If not provided, organizationUuid must be set.   # noqa: E501

        :param beneficiary_uuid: The beneficiary_uuid of this CreateFundingSourceForBenefactorWithPlaidTokenRequest.  # noqa: E501
        :type: str
        """
