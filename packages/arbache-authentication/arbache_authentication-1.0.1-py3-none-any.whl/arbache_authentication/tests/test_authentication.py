...
class TestAutenticacao(TestCase):
    ...
    def test_autenticacao_perfil(self):
        """
            Teste:
                Autenticar um usuário e identificar o seu perfil e level de acesso
            Regra:
                Para ser autenticado é necessário ter o perfil no query_parameters e o
                token de autenticação no headers da request
            Resultado Esperado:
                A requisição terá a adição dos atributos perfil e level, além do
                e-mail do usuário.
        """
