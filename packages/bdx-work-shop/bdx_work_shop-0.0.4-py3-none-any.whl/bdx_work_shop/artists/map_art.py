...
import json,os
import os
if os.path.isfile(os.path.join(os.path.dirname(__file__), "cmap.json"),'r')==False:
    with open((os.path.join(os.path.dirname(__file__), "cmap.json")),"w",encoding="utf-8") as f:
        f.write("""[
  [
    [
      "stone",
