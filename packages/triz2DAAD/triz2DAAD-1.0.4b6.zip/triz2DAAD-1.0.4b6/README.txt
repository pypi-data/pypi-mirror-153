...
Triz2DAAD versión 1.0.4b6 220514 (c) 2019-22 Pedro Fernández
...
- La opción -dr creará una plantilla compatible con DAAD Ready 0.6.
...
**NUEVO**: la opción -dr creará una plantilla compatible con DAAD Ready 0.6. En este modo la barra de estado y la opción -md quedan desactivadas.
...
Triz2DAAD version 1.0.4b6 220514 (c) 2019-22 Pedro Fernández
...
- Option -dr will create a DAAD Ready 0.6 compatible template.
