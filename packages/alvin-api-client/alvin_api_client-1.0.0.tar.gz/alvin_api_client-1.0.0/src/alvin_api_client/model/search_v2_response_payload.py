...
class SearchV2ResponsePayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, results, num_remaining_data, stat_data, total, completed_in, *args, **kwargs):  # noqa: E501
        """SearchV2ResponsePayload - a model defined in OpenAPI

        Args:
            results (PageSearchDisplayPayload):
            num_remaining_data (FilterDataPayload):
        ...
        self.num_remaining_data = num_remaining_data
    ...
    @convert_js_args_to_python_args
    def __init__(self, results, num_remaining_data, stat_data, total, completed_in, *args, **kwargs):  # noqa: E501
        """SearchV2ResponsePayload - a model defined in OpenAPI
