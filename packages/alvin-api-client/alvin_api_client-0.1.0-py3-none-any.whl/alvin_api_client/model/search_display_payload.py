...
class SearchDisplayPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity, html_values, popularity_values, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity, html_values, popularity_values, *args, **kwargs):  # noqa: E501
        """SearchDisplayPayload - a model defined in OpenAPI
