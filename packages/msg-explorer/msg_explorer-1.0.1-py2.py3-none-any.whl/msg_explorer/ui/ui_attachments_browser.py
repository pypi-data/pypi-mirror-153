...
class Ui_AttachmentsBrowser(object):
    def setupUi(self, AttachmentsBrowser):
        ...
        if (self.tableAttachments.columnCount() < 6):
            self.tableAttachments.setColumnCount(6)
    ...
    def retranslateUi(self, AttachmentsBrowser):
        ...
        ___qtablewidgetitem5.setText(QCoreApplication.translate("AttachmentsBrowser", u"Rendering Position", None));
    # retranslateUi
