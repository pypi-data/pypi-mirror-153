...
class ContractManager:
    ...
    def load(self, name: str, contract_name: str, package_name: str = None) -> TContractBase:
        """
        ...
        for item in inspect.getmembers(package_module, inspect.ismodule):
            ...
            if class_def:
                ...
                if not contract_object.address:
                    if not contract_object.resolve_address(contract_name):
