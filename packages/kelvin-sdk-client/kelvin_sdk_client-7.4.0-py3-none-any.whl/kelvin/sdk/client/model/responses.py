...
class ControlChange(DataModelBase):
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """
        Create control changes

        **Permission Required:** `kelvin.permission.control_change.create`.

        ``create``: ``POST`` ``/api/v4/control-changes/create``
    ...
    @classmethod
    def download(
        cls, node: str, fetch: bool = True, _dry_run: bool = False, _client: Any = None
        ...
        **Permission Required:** `kelvin.permission.control_change.read`.
        ...
        ``download``: ``GET`` ``/api/v4/control-changes/sync/{node}/download``
    ...
    def upload(
        ...
        **Permission Required:** `kelvin.permission.control_change.create`.
        ...
        ``upload``: ``POST`` ``/api/v4/control-changes/sync/{node}/upload``
...
class AssetItem(DataModelBase):
    ...
    def create_asset_oee(
        ...
        **Permission Required:** `kelvin.permission.asset.create`.
        ...
        ``createAssetOEE``: ``POST`` ``/api/v4/assets/oee/{asset_name}/create``
        ...
        **kwargs:
        ...
        result = self_or_cls._make_request(
            _client,
            "post",
            "/api/v4/assets/oee/{asset_name}/create",
            {"asset_name": asset_name},
            {},
            {},
            {},
    ...
    def create_asset_shift(
        ...
        **Permission Required:** `kelvin.permission.asset.create`.
        ...
        ``createAssetShift``: ``POST`` ``/api/v4/assets/shift/create``
    ...
    def list_site_hierarchy_overview(
        ...
        **Pagination Sortable Columns:** `asset.name`, `asset.asset_type_name`, `asset.title`, `asset.failure_quotient`

        **Permission Required:** `kelvin.permission.asset.read`.

        ``listSiteHierarchyOverview``: ``POST`` ``/api/v4/assets/site-hierarchy-overview/{site_name}/list``
        ...
        **kwargs:
        ...
        result = cls._make_request(
            _client,
            "post",
            "/api/v4/assets/site-hierarchy-overview/{site_name}/list",
            {"site_name": site_name},
            {
                "page_size": page_size,
                "starting_after": starting_after,
    ...
    def get_asset_hierarchy(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        result = self_or_cls._make_request(
            ...
            {"asset_name": asset_name},
            {"entity_type_depth": entity_type_depth},
            {},
            {},
            None,
            None,
...
class Thread(DataModelBase):
    ...
    @classmethod
    def create_thread(cls, body: str, _dry_run: bool = False, _client: Any = None) -> Thread:
        """
        Create Thread
    ...
    @DataModelBase.translate({"thread_id": "id"})
    def update_thread(
        self_or_cls, thread_id: str, body: str, _dry_run: bool = False, _client: Any = None
    ) -> Thread:
        """
        Update Thread
