...
class spotify:
    ...
    def register_account(self):
        ...
        data = f"birth_day=11&birth_month=12&birth_year=1976&collect_personal_info=undefined&creation_flow=&creation_point=https://www.spotify.com/uk/&displayname={random.choice(name)}&email={email}&gender=neutral&iagree=1&key=a1e486e2729f46d6bb368d6b2bcda326&password={password}&password_repeat={password}&platform=www&referrer=&send-email=1&thirdpartyemail=0&fb=0"
        try:
    ...
    def follow(self):
        ...
        if login_token == None:
            return None, "while registering, ratelimit (Maybe IP got blacklisted or is temporarily blocked"
