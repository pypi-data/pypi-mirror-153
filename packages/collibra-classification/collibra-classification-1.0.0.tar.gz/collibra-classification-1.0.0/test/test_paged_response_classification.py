...
from collibra_classification.models.paged_response_classification import PagedResponseClassification  # noqa: E501
...
class TestPagedResponseClassification(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = collibra_classification.models.paged_response_classification.PagedResponseClassification()  # noqa: E501
        if include_optional :
            return PagedResponseClassification(
                ...
                limit = 100, 
                results = [
                    collibra_classification.models.classification.Classification(
                        id = '0', 
