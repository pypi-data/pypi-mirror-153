...
class AddClassificationMatchRequest(object):
    ...
    def __init__(self, asset_id=None, classification_id=None, local_vars_configuration=None):  # noqa: E501
        """AddClassificationMatchRequest - a model defined in OpenAPI"""  # noqa: E501
