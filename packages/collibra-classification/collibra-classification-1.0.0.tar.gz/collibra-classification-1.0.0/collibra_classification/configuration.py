...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of collibra_classification.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = collibra_classification.Configuration(
    ...
    Note you can use the constants defined in the collibra_classification.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = collibra_classification.Configuration(
        signing_info = collibra_classification.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost/rest/catalog/1.0",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("collibra_classification")
