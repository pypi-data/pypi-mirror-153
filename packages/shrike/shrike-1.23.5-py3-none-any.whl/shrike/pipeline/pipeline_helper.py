...
class AMLPipelineHelper:
    ...
    def _get_component_name_from_instance(self, component_instance):
        """We need to have this _get_component_name_from_instance() to get component name for apply_smart_runsettings(),
        and can't simply use "component_name = component_instance.name". Otherwise apply_smart_runsettings() might work incorrectly for local
        components. See more detailed explanation and examples here: https://github.com/Azure/shrike/issues/411"""
