...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of collibra_search.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the collibra_search.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = collibra_search.Configuration(
        signing_info = collibra_search.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
