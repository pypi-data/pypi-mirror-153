(self["webpackChunktableviewwidget"] = self["webpackChunktableviewwidget"] || []).push([["lib_tableview_widget_js"],{
...
class TableView extends base_1.DOMWidgetView {
    ...
    table_body_changed() {
        ...
        for (const i in table_body_list) {
            const row = (0, jquery_1.default)('<tr/>');
            this.table_body.append(row);
            for (const j in table_body_list[i]) {
                const col = (0, jquery_1.default)('<td/>').text(table_body_list[i][j]);
                row.append(col);
            }
        }
    ...
    set_selected_row() {
        ...
        if (index === -1) {
            (0, jquery_1.default)('table')
                .find('tbody tr')
                .each((_i, tr) => {
                (0, jquery_1.default)(tr).removeClass('selected');
            });
        }
        else {
            const tr = (0, jquery_1.default)('table').find('tbody tr')[index];
            (0, jquery_1.default)(tr).addClass('selected').siblings().removeClass('selected');
        }
    }
    set_onclick_handler() {
    ...
    auto_size_columns() {
        const $table = (0, jquery_1.default)('table');
        ...
        const headColWidth = $headCells
            .map(function () {
            return (0, jquery_1.default)(this).width();
        })
            .get();
        ...
        $table
            ...
            .children()
            .each((i, v) => {
            (0, jquery_1.default)(v).width(colWidth[i]);
        });
        $table
            .find('thead tr')
            .children()
    ...
    makeTable(headers) {
        const table = (0, jquery_1.default)('<table/>').addClass('tb');
        const header = (0, jquery_1.default)('<thead/>');
        table.append(header);
        const row = (0, jquery_1.default)('<tr/>');
        header.append(row);
        for (const index in headers) {
            const col = (0, jquery_1.default)('<th/>').text(headers[index]);
            row.append(col);
        }
        this.table_body = (0, jquery_1.default)('<tbody/>');
