...
# https://github.com/alex-ber/AlexBerUtils/blob/master/alexber/utils/stdlogging.py
...
def initStream(logger=None, logger_level=logging.INFO, stream_getter=None, stream_setter=None, adapter_cls=None):
    """
    Preffered API.
    ...
    sl = adapter_cls(logger=logger, stream=stream, log_level=logger_level)
    stream_setter(sl)
