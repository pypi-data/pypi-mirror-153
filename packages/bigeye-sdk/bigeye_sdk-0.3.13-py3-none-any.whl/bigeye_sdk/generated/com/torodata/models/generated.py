...
class LineageNavigationNodeResponse(betterproto.Message):
    ...
    distance_upstream: int = betterproto.int32_field(2)
    distance_downstream: int = betterproto.int32_field(3)
    upstream_edges: List["LineageRelationshipSimple"] = betterproto.message_field(4)
    downstream_edges: List["LineageRelationshipSimple"] = betterproto.message_field(5)
    issue_count: int = betterproto.int32_field(6)
    is_root_cause: bool = betterproto.bool_field(7)
