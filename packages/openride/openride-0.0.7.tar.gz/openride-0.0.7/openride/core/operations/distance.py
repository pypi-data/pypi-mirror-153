...
def distance(obj1:Point, obj2:BoundingBox) -> float:
    return distance_between_box_and_point_3d(obj2.get_vertices(), obj1.x, obj1.y, obj1.z)
...
def distance(obj1:BoundingBox, obj2:Point) -> float:
    return distance_between_box_and_point_3d(obj1.get_vertices(), obj2.x, obj2.y, obj2.z)
