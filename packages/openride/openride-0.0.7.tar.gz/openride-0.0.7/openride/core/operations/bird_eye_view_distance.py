...
def bird_eye_view_distance(obj1:BoundingBox, obj2:BoundingBox) -> float:
    return bev_distance_between_boxes(obj1.get_bird_eye_view_vertices(), obj2.get_bird_eye_view_vertices())


@dispatch(BoundingBox, Polyline)
def bird_eye_view_distance(obj1:BoundingBox, obj2:Polyline) -> float:
    return bev_distance_between_line_and_box(obj2.vertices, obj1.get_bird_eye_view_vertices())


@dispatch(BoundingBox, Polygon)
def bird_eye_view_distance(obj1:BoundingBox, obj2:Polygon) -> float:
    return bev_distance_between_polygons(obj1.get_bird_eye_view_vertices(), obj2.vertices)
...
def bird_eye_view_distance(obj1:Polyline, obj2:BoundingBox) -> float:
    return bev_distance_between_line_and_box(obj1.vertices, obj2.get_bird_eye_view_vertices())
...
def bird_eye_view_distance(obj1:Polygon, obj2:BoundingBox) -> float:
    return bev_distance_between_polygons(obj1.vertices, obj2.get_bird_eye_view_vertices())
