from openride import bird_eye_view_distance
...
pytest_bev_distance_benchmark = pytest.mark.benchmark(
    group="bird_eye_view_distances",
    min_time=0.01,
    max_time=0.05,
    min_rounds=5,
    warmup=True,
