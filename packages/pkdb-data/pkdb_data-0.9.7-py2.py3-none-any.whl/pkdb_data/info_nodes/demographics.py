"""
Information related to demographics such as income, education and other social factors.
"""


from pkdb_data.info_nodes.units import NO_UNIT
...
DEMOGRAPHICS_NODES = [
    MeasurementType(
        ...
        description="Demographics measurement. Information related to education, income and"
        "social factors.",
        parents=["measurement"],
    ...
    MeasurementType(
        ...
        description="Education measurement. Information related to eduction status or duration.",
