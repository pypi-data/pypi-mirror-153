...
"""
from pkdb_data.management.info_node import Choice, DType, MeasurementType
...
ANTHROPOMETRY_NODES = [
    MeasurementType(
        ...
        description="Anthropometry is a measurement of the size, weight, and proportions "
        "of the human or other primate body.",
    ...
    Choice(
        sid="elder",
        description="Elder. Normally in the range >65 years. An age group comprised of individuals 65 years of "
        "age and older.",
    ...
    Choice(
        sid="adult",
        description="Adult. Normally in the range 35 - 65 years. An age group comprised of humans who have "
    ...
    Choice(
        sid="adolescent",
        description="Adolescent. Normally in the range <18. An age group comprised of juveniles between the onset "
        "of puberty and maturity; in the state of development between puberty and maturity.",
        parents=["age (categorial)"],
        annotations=[
            (BQB.IS, "ncit/C27954"),
            (BQB.IS, "omit/0001723"),
    ...
    Choice(
        sid="child",
        description="Child. An age group comprised of individuals who are not yet an adult. "
        "The specific cut-off age will vary by purpose. A young person who is between infancy and adulthood.",
        parents=["age (categorial)"],
        annotations=[
            (BQB.IS, "ncit/C16423"),
            (BQB.IS, "omit/0003972"),
    ...
    MeasurementType(
        sid="sex",
        description="Sex of subject or animal. The assemblage of physical properties or "
        "qualities by which male is distinguished from female; the physical difference "
        "between male and female; the distinguishing peculiarity of male or female.",
        parents=["anthropometric measurement"],
        dtype=DType.CATEGORICAL,
        annotations=[
            (BQB.IS, "ncit/C16576"),
    ...
    Choice(
        ...
        name="F",
        label="female",
        description="Female is a biological sex of an individual with female sexual organs.",
        parents=["sex"],
        annotations=[
            (BQB.IS, "ncit/C166576"),
            (BQB.IS, "sio/SIO:010052"),
        ],
    ...
    Choice(
        ...
        description="Males and females without exact count. Mixed sex allows to encode that men "
        "and women participated in a group.",
        parents=["sex"],
    ...
    MeasurementType(
        ...
        description="Body mass index (BMI) calculated as weight/height^2. An indicator of "
        "body density. For adults, BMI falls into these categories: "
    ...
    MeasurementType(
        sid="weight",
        description="Body weight of subject or animal. The mass or quantity of heaviness of an individual. "
        "It is expressed by units of kilograms or pounds.",
    ...
    MeasurementType(
        ...
        description="Waist to hip ratio (WHR). The ratio of the abdominal circumference "
        "at the navel to maximum hip and buttocks circumference; looks at "
    ...
    MeasurementType(
        sid="obesity-index",
        name="obesity index",
        description="Obesity index (percent of normal body weight or ideal body weight - "
        "IBW). Values larger than "
    ...
    MeasurementType(
        ...
        description="Portion of the body not comprised of lipids often calculated as fat free mass equal to "
