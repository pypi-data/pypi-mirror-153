...
version = '0.0.6'
long_description = """Python Module for simply Colloboratioin filtering recommendation system. With use cellular automaton.
                    Нyou have to apply for entry Dataframe User-Item"""
setup(
    name='recsyscell',
    version=version,
