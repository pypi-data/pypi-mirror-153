...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, pulp_created=None, latest_version_href=None, pulp_href=None, name=None, pulp_labels=None, retain_repo_versions=None, versions_href=None, description=None, local_vars_configuration=None):  # noqa: E501
