...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, pulp_created=None, pulp_href=None, pulp_labels=None, content_guard=None, name=None, base_path=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
