...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, manifest_signing_service=None, pulp_created=None, versions_href=None, description=None, pulp_labels=None, pulp_href=None, retain_repo_versions=None, name=None, local_vars_configuration=None):  # noqa: E501
