...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, pulp_href=None, pulp_labels=None, latest_version_href=None, name=None, retain_repo_versions=None, manifest_signing_service=None, versions_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
