...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, pulp_labels=None, latest_version_href=None, retain_repo_versions=None, versions_href=None, description=None, pulp_created=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
