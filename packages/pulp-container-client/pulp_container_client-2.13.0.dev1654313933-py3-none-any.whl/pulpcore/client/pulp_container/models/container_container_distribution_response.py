...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, pulp_labels=None, content_guard=None, base_path=None, repository=None, pulp_created=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
