...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, description=None, pulp_labels=None, retain_repo_versions=None, name=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
