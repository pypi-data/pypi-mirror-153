...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, pulp_labels=None, latest_version_href=None, pulp_href=None, retain_repo_versions=None, pulp_created=None, name=None, versions_href=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
