...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, pulp_labels=None, content_guard=None, base_path=None, repository=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
