...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, description=None, pulp_href=None, pulp_labels=None, versions_href=None, latest_version_href=None, manifest_signing_service=None, name=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
