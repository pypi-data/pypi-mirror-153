...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, retain_repo_versions=None, description=None, pulp_labels=None, manifest_signing_service=None, name=None, local_vars_configuration=None):  # noqa: E501
