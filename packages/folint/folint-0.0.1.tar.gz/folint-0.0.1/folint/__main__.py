...
def extra(file):
    ...
    f.close()               #close file
    return len(fouten)      #return aantal gevonden fouten
...
def main():
    ...
    try:
        ...
        if sys.argv[1].endswith(".idp"):        # check file extension
            idp = IDP.from_file(sys.argv[1])    # parse idp file to AST
            if args.AST:
                idp.printAST(0)                 # print AST of file
    ...
    except IDPZ3Error as e1:    # catch IDP-Z3 error
