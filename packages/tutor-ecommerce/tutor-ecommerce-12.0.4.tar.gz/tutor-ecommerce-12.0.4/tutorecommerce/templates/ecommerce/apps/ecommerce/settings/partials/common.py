...
if "cybersource" in PAYMENT_PROCESSOR_CONFIG["openedx"] and "cybersource-rest" not in PAYMENT_PROCESSOR_CONFIG["openedx"]:
    PAYMENT_PROCESSOR_CONFIG["openedx"]["cybersource-rest"] = PAYMENT_PROCESSOR_CONFIG["openedx"]["cybersource"]
