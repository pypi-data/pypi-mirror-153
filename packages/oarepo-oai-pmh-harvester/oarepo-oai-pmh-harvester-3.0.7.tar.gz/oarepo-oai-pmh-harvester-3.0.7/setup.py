...
{'invenio_base.api_apps': ['oarepo_oaipmh_harvester = '
 ...
 'invenio_jsonschemas.schemas': ['oarepo_oaipmh_harvester_batch_metadata = '
                                 'oarepo_oaipmh_harvester.oaipmh_batch.record.jsonschemas',
                                 'oarepo_oaipmh_harvester_config_metadata = '
                                 'oarepo_oaipmh_harvester.oaipmh_config.record.jsonschemas',
                                 'oarepo_oaipmh_harvester_record_metadata = '
                                 'oarepo_oaipmh_harvester.oaipmh_record.record.jsonschemas',
                                 'oarepo_oaipmh_harvester_run_metadata = '
                                 'oarepo_oaipmh_harvester.oaipmh_run.record.jsonschemas'],
 'invenio_search.mappings': ['oarepo_oaipmh_harvester_batch_mapping = '
                             'oarepo_oaipmh_harvester.oaipmh_batch.record.mappings',
                             'oarepo_oaipmh_harvester_config_mapping = '
                             'oarepo_oaipmh_harvester.oaipmh_config.record.mappings',
                             'oarepo_oaipmh_harvester_record_mapping = '
                             'oarepo_oaipmh_harvester.oaipmh_record.record.mappings',
                             'oarepo_oaipmh_harvester_run_mapping = '
                             'oarepo_oaipmh_harvester.oaipmh_run.record.mappings'],
