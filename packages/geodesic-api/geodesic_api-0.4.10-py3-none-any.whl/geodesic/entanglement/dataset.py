...
class Dataset(Object):
    ...
    @staticmethod
    def from_arcgis_service(name: str, url: str, credential=None, gis=None) -> 'Dataset':
        if url.endswith('/'):
            url = url[:-1]
        ...
        if dataset_alias is None:
            ...
            if item_id is None:
                ...
                return Dataset.from_arcgis_item(name=name, item_id=item_id, credential=credential, gis=gis)
