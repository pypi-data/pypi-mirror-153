...
os.environ["AD_SITE_CNAME"] = "ftools.aero-ftools.com"
os.environ["AD_SITE_URL"] = "ftools.a.aero-ftools.com"  # specific to site
...
def modify_record_targetIP(url=None, targetIP=None):
    if not url:
...
def modify_record_cname(url=None, cname_target=None):
    if not url:
