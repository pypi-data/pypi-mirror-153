...
class PDFImageCompare:
    ...
    def __init__(self, pdf1, pdf2, expected_header, height_header, height_bottom_date, height_bottom_footnote,
                 height_private_block, expected_header_path, artifacts, diff_images, case_diff_image_dir=''):
        ...
        if case_diff_image_dir != '':
            self.case_diff_image_dir = os.path.join(self.diff_images, case_diff_image_dir)
