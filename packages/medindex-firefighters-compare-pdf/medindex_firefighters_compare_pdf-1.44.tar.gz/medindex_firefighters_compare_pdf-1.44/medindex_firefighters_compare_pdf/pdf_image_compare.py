...
class PDFImageCompare:
    ...
    def __init__(self, pdf1, pdf2, height_header, height_bottom_date, height_bottom_footnote,
                 expected_header_path, artifacts, diff_images, case=''):
    ...
    def get_header_diff(self, expected_header):
        actual_header = self.pdf1_list[0].clone()
        self.get_header(actual_header, None, self.height_header)
        expected_header = Image(filename=(os.path.join(self.expected_header_path, expected_header)))
    ...
    def get_body_diff(self, height_private_block):
        compare_results = []
        count = 0
    ...
    def get_private_data_diff(self, height_private_block):
