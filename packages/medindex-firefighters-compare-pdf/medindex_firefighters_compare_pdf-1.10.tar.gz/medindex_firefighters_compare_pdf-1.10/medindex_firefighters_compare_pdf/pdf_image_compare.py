...
class PDFImageCompare:
    ...
    def __init__(self, pdf1, pdf2, expected_header, case, height_header, height_bottom_date, height_bottom_footnote, height_private_block, expected_header_path, artifacts, diff_images):
    ...
    def get_body_diff(self):
        ...
        for pdf1_img, pdf2_img in zip(self.pdf1_list, self.pdf2_list):
            ...
            self.cut_bottom(pdf1_img, pdf2_img, height_bottom=self.height_bottom_date + self.height_bottom_footnote)
            self.cut_header(pdf1_img, pdf2_img, height_header=self.height_header + self.height_private_block)
