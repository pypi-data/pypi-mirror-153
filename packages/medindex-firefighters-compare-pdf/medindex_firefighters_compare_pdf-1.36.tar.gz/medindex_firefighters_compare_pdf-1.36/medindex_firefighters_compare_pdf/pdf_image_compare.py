...
class PDFImageCompare:
    ...
    def __init__(self, pdf1, pdf2, expected_header, height_header, height_bottom_date, height_bottom_footnote, height_private_block, expected_header_path, artifacts, diff_images, case=''):
    ...
    #def cut_header(pdf1_image_path, pdf2_image_path, height_header=HEIGHT_HEADER):
        w, h = pdf1_image_path.size
        w2, h2 = pdf2_image_path.size
        if w > w2:
            w = w2
    ...
    #def get_header(pdf1_image_path, pdf2_image_path, height_header=HEIGHT_HEADER):
        w, h = pdf1_image_path.size
    ...
    def get_body_diff(self):
        ...
        for pdf1_img, pdf2_img in zip(self.pdf1_list, self.pdf2_list):
            ...
            #self.cut_header(pdf1_img, pdf2_img, HEIGHT_HEADER + self.height_private_block)
    ...
    def get_private_data_diff(self):
        ...
        #else:
        #    self.cut_header(pdf1_img, pdf2_img)
