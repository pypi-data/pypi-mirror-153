...
class PDFImageCompare:
    ...
    def __init__(self, pdf1, pdf2, expected_header, height_bottom_date, height_bottom_footnote, height_private_block, expected_header_path, artifacts, diff_images, case=None, height_header=None):
