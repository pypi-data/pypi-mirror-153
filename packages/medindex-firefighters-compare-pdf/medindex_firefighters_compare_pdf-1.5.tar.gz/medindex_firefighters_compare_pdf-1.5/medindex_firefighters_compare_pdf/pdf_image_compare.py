...
class PDFImageCompare:
    ...
    EXPECTED_HEADER_PATH = os.getenv('EXPECTED_HEADER_PATH', '')

    def __init__(self, pdf1, pdf2, expected_header, case, height_header):
    ...
    def get_header_diff(self):
        ...
        expected_header = Image(filename=(os.path.join(EXPECTED_HEADER_PATH, self.expected_header)))
