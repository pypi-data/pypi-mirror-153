...
setup(name = 'sals_sports_simulator',
      version = '1.2',
      description = 'Simulate the results of a sporting event.',
      packages = ['sals_sports_simulator'],
      author = 'Sal Cacciatore',
      author_email = 'scacciatore1@gmail.com',
      zip_safe = False)
