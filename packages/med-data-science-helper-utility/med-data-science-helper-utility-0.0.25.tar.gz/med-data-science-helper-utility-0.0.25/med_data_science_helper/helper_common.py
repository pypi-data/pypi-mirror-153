...
def get_niveles_grados_por_modalidad(modalidad=None,id_nivel_list=None, grado_list=None,rt_ngm=True,rt_key=False,rt_niveles=False):
    ...
    for id_nivel_ in id_nivel_list:
        ...
        if id_nivel_=="E2":
            list_id_grados_ = [(6,"PR_PRIMERO",7),(7,"PR_SEGUNDO",8),(8,"PR_TERCERO",10),(9,"PR_CUARTO",11),(10,"PR_QUINTO",13),(11,"PR_SEXTO",14)]
        ...
        if id_nivel_=="B0":
            list_id_grados_ = [(4,"PR_PRIMERO",6),(5,"PR_SEGUNDO",7),(6,"PR_TERCERO",8),(7,"PR_CUARTO",9),(8,"PR_QUINTO",10),(9,"PR_SEXTO",11)]
            
        if id_nivel_=="F0":
            list_id_grados_ = [(10,"SC_PRIMERO",12),(11,"SC_SEGUNDO",13),(12,"SC_TERCERO",14),(13,"SC_CUARTO",15),(14,"SC_QUINTO",16)]  
