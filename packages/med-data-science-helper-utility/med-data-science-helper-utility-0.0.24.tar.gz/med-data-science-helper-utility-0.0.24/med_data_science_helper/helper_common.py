...
def get_niveles_grados_por_modalidad(modalidad=None,id_nivel_list=None, grado_list=None,rt_ngm=True,rt_key=False,rt_niveles=False):
    ...
    for id_nivel_ in id_nivel_list:
        ...
        if id_nivel_=="E2":
            list_id_grados_ = [(6,"PRIMARIA_PRIMERO",7),(7,"PRIMARIA_SEGUNDO",8),(8,"PRIMARIA_TERCERO",10),(9,"PRIMARIA_CUARTO",11),(10,"PRIMARIA_QUINTO",13),(11,"PRIMARIA_SEXTO",14)]
        
        if id_nivel_=="A1":
            list_id_grados_ = [(1,"0_2_ANIOS",2)]
        
        if id_nivel_=="A2":
            list_id_grados_ = [(3,"GRUPO_3_ANIOS",3),(4,"GRUPO_4_ANIOS",4),(5,"GRUPO_5_ANIOS",5)]
        ...
        if id_nivel_=="B0":
            list_id_grados_ = [(4,"PRIMARIA_PRIMERO",6),(5,"PRIMARIA_SEGUNDO",7),(6,"PRIMARIA_TERCERO",8),(7,"PRIMARIA_CUARTO",9),(8,"PRIMARIA_QUINTO",10),(9,"PRIMARIA_SEXTO",11)]
            
        if id_nivel_=="F0":
            list_id_grados_ = [(10,"SECUNDARIA_PRIMERO",12),(11,"SECUNDARIA_SEGUNDO",13),(12,"SECUNDARIA_TERCERO",14),(13,"SECUNDARIA_CUARTO",15),(14,"SECUNDARIA_QUINTO",16)]  
