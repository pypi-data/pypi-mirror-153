...
def create_scaffold(platform):
    ...
    create_file(
        os.path.join(project_name, 'test_dir', 'test_data', "__init__.py"),
        '',
    )
    create_folder(os.path.join(project_name, 'test_dir', 'test_data'))
    create_file(
        os.path.join(project_name, 'test_dir', 'test_data', "data.json"),
        data_content,
    )
    create_file(
        os.path.join(project_name, 'test_dir', 'test_data', "__init__.py"),
