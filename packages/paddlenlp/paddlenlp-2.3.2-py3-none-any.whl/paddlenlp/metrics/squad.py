...
def compute_prediction(examples,
    ...
    print("examples number:{}".format(len(examples)))
    print("example 0")
    print(examples[0].keys())
    print(examples[0])

    print("features number:{}".format(len(features)))
    print("features 0")
    print(features[0].keys())
    print(features[0])

    print("predictions number:{}".format(len(predictions[0])))
    ...
    print("all_predictions number:{}".format(len(all_predictions)))
