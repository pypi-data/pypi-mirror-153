...
class Feed:
    ...
    @staticmethod
    def read_columns(data_bucket: str, data_key: str, delimiter: str) -> list:
        """
        ...
        :param data_key:str: Specify the key of the file in s3 that you want to get the columns from
        ...
        """
        try:
            for file in s3.Bucket(data_bucket).objects.filter(Prefix=data_key):
