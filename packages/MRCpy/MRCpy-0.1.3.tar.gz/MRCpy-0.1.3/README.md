...
### IMPORTANT NOTE
When downloading the MRCpy library from PyPI (via `pip`), the `MRCpy.datasets` module (including the data `loaders`) are not downloaded due to space issues. If you want to obtain the datasets module, please download it from [MRCpy github page](https://github.com/MachineLearningBCAM/MRCpy).
