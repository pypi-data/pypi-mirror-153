...
from hestia_earth.schema import is_schema_type
...
def list_models(
    tier: str = None, productTermId: str = None, productTermType: str = None, siteType: str = None
) -> list:
    """
...
def get_all(
    debug: bool = False, tier: str = None, productTermId: str = None, productTermType: str = None, siteType: str = None
) -> dict:
    """
    ...
    """
    models = list_models(tier=tier, productTermId=productTermId, productTermType=productTermType, siteType=siteType)
    if debug:
        print(f"{len(models)} models found")
        for model in models:
            print('/'.join([model.get('model'), model.get('key')]))
    else:
        print(f"{len(models)} models found, fetching requirements...")
