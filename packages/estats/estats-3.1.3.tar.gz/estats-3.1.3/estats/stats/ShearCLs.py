...
def context():
    ...
    required = ['lmax', 'ShearCLs_sliced_bins', 'ShearCLs_min',
                'ShearCLs_max', 'cl_engine']
    defaults = [1000, 20, 100, 1000, 'anafast']
    types = ['int', 'int', 'int', 'int', 'str']
    return required, defaults, types, stat_type


def ShearCLs(map_1, map_2, weight_map, ctx):
    """
