...
class _ConvNd_cdopt(nn.Module):
    ...
    def __init__(self,
                 ...
                 padding_mode: str,
                 device=None,
                 dtype=None, manifold_class = euclidean_torch,  weight_var_transfer = None) -> None:
        ...
        self.manifold = manifold_class(self.var_shape, device=device, dtype= dtype)
...
class Conv1d_cdopt(_ConvNd_cdopt):
    ...
    def __init__(
        ...
        device=None,
        dtype=None, manifold_class = euclidean_torch,  weight_var_transfer = None
    ) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        ...
        super(Conv1d_cdopt, self).__init__(
            ...
            False, _single(0), groups, bias, padding_mode, **factory_kwargs, manifold_class = manifold_class,  weight_var_transfer = weight_var_transfer)
...
class Conv2d_cdopt(_ConvNd_cdopt):
    ...
    def __init__(
        ...
        super(Conv2d_cdopt, self).__init__(
            in_channels, out_channels, kernel_size_, stride_, padding_, dilation_,
            False, _pair(0), groups, bias, padding_mode, **factory_kwargs, manifold_class = manifold_class,  weight_var_transfer = weight_var_transfer)
...
class Conv3d_cdopt(_ConvNd_cdopt):
    ...
    def __init__(
        ...
        super(Conv3d_cdopt, self).__init__(
            in_channels, out_channels, kernel_size_, stride_, padding_, dilation_,
            False, _triple(0), groups, bias, padding_mode, **factory_kwargs, manifold_class = manifold_class,  weight_var_transfer = weight_var_transfer)
