    ...
    if len(od_matrix_agg) > 0:
        ...
        if gmaps_ok:
            ...
            if trip_datetime > datetime.datetime.now():
                ...
                for ii in od_matrix_agg.trip_datetime.astype(str).str[:10].unique():
                ...
                if answer.lower() == 'si':
                    ...
                    if not only_distance_duration:
                        ...
                        for i in od_matrix_agg.trip_datetime.unique():
                            ...
                            save_key(tmp / Path('save_key.csv'), key, i, (transit+((driving)*1.5)+walking+bicycling)*len(trips_new), current_path)
