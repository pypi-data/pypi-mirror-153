...
class Axis(object):
    ...
    def write_regs(self, address, data):
        return self.retry(self._client.write_registers)(address, data, skip_encode=True, unit=self._slave_id)
    ...
    def write_coil(self, address, value):
        self.retry(self._client.write_coil)(address, value)
    ...
    def reset_error(self):
        self.write_coil(const.IO_IN_ERROR_RESET)

    def set_servo_on_off(self,on_off):
        self.write_coil(const.IO_IN_SERVO)
