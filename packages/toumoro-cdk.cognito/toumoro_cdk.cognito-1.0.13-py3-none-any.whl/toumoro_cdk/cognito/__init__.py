...
class TmUserPoolClient(
    ...
    def user_pool_client_secret(self) -> aws_cdk.aws_cognito.UserPoolClient:
        return typing.cast(aws_cdk.aws_cognito.UserPoolClient, jsii.get(self, "userPoolClientSecret"))

    @user_pool_client_secret.setter
    def user_pool_client_secret(
        self,
        value: aws_cdk.aws_cognito.UserPoolClient,
    ) -> None:
        jsii.set(self, "userPoolClientSecret", value)
