Thai Language Toolkit Project  version 1.5.6
============================================
...
* avgwrdbase = 0. ## ratio of basic vocab from min.of Education per total
* avgtfidf = 0.  ## average of tfidf of each word 
* avgtncdisp = 0. ## average of dispersion of each word from TNC
* avgttcdisp = 0. ## average of dispersion of each word from TTC
