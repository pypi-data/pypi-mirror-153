...
class DataView(object):
    ...
    def __init__(self, parent=None, label=None, description=None, columns=None, group_by=None, file_spec=None, include_ids=None, include_labels=None, error_column=None, missing_data_strategy=None, sort=None, id=None, origin=None):  # noqa: E501
