...
class FeatureView(FeatureDefinition):
    ...
    def feature_start_time(self) -> Optional[pendulum.DateTime]:
        ...
        """
        # TODO(Jake): Return the feature_start_time instead of the materialization_start_timestamp in https://github.com/tecton-ai/tecton/pull/4239.
        if not self._proto.HasField("materialization_params"):
            return None
        return pendulum.from_timestamp(self._proto.materialization_params.materialization_start_timestamp.ToSeconds())
