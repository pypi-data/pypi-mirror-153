...
def current_access_token_is_valid():
    ...
    if access_token is None:
        ...
        access_token_dict = jwt.decode(access_token, verify=False)
...
def login():
    ...
    if bx_token is not None:
        user_id = jwt.decode(bx_token, verify=False)['batchx-id']
