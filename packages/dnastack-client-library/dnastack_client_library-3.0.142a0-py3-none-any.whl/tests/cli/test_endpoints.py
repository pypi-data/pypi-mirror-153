...
class TestCommand(CliTestCase):
    def test_happy_path(self):
        ...
        self.assertEqual(self.simple_invoke('config', 'endpoints', 'get-defaults')['collections'], 'sample-viral-ai')
        ...
        self.assertEqual(self.simple_invoke('config', 'endpoints', 'get-defaults')['collections'], 'sample-viral-ai-secondary')
