...
class TestCliServiceRegistry(CliTestCase):
    def test_happy_path(self):
        ...
        self.invoke('config', 'registries', 'sync', 'gcp-staging')
        ...
        self.invoke('config', 'registries', 'add', 'gcp-prod',
        ...
        gcp_prod_endpoints = self.simple_invoke('config', 'registries', 'list-endpoints', 'gcp-prod')
        ...
        self._assert_if_endpoint_lists_are_identical(gcp_prod_endpoints,
                                                     self.simple_invoke('config', 'registries', 'list-endpoints', 'gcp-prod'))
    ...
    def test_user_cannot_add_registry_with_known_id(self):
        ...
        self.expect_error_from(['config', 'registries', 'add', 'panda-service', 'https://panda.faux.dnastack.com'],
    ...
    def test_user_cannot_add_registry_with_known_registry_url(self):
        ...
        self.expect_error_from(['config', 'registries', 'add', 'test-registry-002',
                                'https://collection-service.staging.dnastack.com/service-registry/'],
                               error_regex='^EndpointAlreadyExists:')
