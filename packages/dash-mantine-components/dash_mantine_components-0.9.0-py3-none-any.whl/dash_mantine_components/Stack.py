...
- style (dict; optional):
    Inline style."""
    @_explicitize_args
    def __init__(self, children=None, align=Component.UNDEFINED, class_name=Component.UNDEFINED, justify=Component.UNDEFINED, spacing=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'align', 'class_name', 'justify', 'spacing', 'style']
        self._type = 'Stack'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'align', 'class_name', 'justify', 'spacing', 'style']
