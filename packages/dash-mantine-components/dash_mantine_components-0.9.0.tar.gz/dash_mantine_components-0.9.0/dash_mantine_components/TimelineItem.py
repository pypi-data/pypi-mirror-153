...
- title (boolean | number | string | dict | list; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, align=Component.UNDEFINED, bullet=Component.UNDEFINED, bulletSize=Component.UNDEFINED, color=Component.UNDEFINED, lineVariant=Component.UNDEFINED, lineWidth=Component.UNDEFINED, radius=Component.UNDEFINED, title=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'align', 'bullet', 'bulletSize', 'color', 'lineVariant', 'lineWidth', 'radius', 'title']
        self._type = 'TimelineItem'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'align', 'bullet', 'bulletSize', 'color', 'lineVariant', 'lineWidth', 'radius', 'title']
