...
cdef class SSCompositeCriterion(SSRegressionCriterion):
    ...
    cdef int init(
        ...
        with gil:
            print('*** SS CRIT children', self.supervised_criterion, self.unsupervised_criterion)
            print('*** SS CRIT 1')
            print('*** SS CRIT features, outputs, shapes:',
                self.n_features,
                self.n_outputs,
                self.X.shape,
                self.y.shape,
...
cdef class SSMSE(SSCompositeCriterion):
    ...
    def __init__(
        ...
        *args, **kwargs,
        ...
        print('*** SS CRIT __init__ sup', self.supervision)
        print('*** SS CRIT', self.supervised_criterion, self.unsupervised_criterion)
        print('*** SS CRIT', n_features, n_outputs, n_samples)
        print('*** SS CRIT', self.supervised_criterion.n_outputs, self.supervised_criterion.n_samples)
        print('*** SS CRIT', self.unsupervised_criterion.n_outputs, self.unsupervised_criterion.n_samples)
        print('*** SS CRIT', self.n_features, self.n_outputs, self.n_samples)
