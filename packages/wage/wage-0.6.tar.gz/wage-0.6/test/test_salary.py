...
class TestSalary(unittest.TestCase):
    ...
    def test_serialize_per_period(self):
        s = Salary(31200, 'year')
        per_period = json.loads(s.serialize_per_period())
    ...
    def test_serialize(self):
        ...
        self.assertIsNotNone(obj['per_period'])
        self.assertIsNotNone(obj['times_per_year'])
        self.assertIsInstance(obj['per_period'], dict)
