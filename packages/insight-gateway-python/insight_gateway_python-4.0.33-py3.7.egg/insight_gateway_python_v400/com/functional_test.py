...
def onSubscribe_StockType_MD_TICK(mdStock):
    pass
    # print(mdStock)
...
def onSubscribe_IndexType_MD_TICK(mdIndex):
    pass
    # print(mdIndex)
...
def onSubscribe_BondType_MD_TICK(mdBond):
    pass
    # print(mdBond)
...
def onSubscribe_FundType_MD_TICK(mdFund):
    pass
    # print(mdFund)
...
def onSubscribe_OptionType_MD_TICK(mdOption):
    pass
    # print(mdOption)
...
# 处理订阅的期权Tick数据，格式为json格式
# 订阅的证券类型为ESecurityType.OptionType
def onSubscribe_FuturesType_MD_TICK(mdFuture):
    pass
    # print(mdFuture)
...
def onSubscribe_MD_TRANSACTION_and_MD_ORDER(marketdatajson):
...
def onPlayback_StockType_MD_TICK(mdStock):
    pass
    #print(mdStock)
...
def onPlayback_IndexType_MD_TICK(mdIndex):
    pass
    # print(mdIndex)
...
def onPlayback_BondType_MD_TICK(mdBond):
    pass
    # print(mdBond)
...
def onPlayback_FundType_MD_TICK(mdFund):
    pass
    # print(mdFund)
...
def onPlayback_OptionType_MD_TICK(mdOption):
    pass
    # print(mdOption)
...
# 处理回放的期权Tick数据，格式为json格式
# 回放的证券类型为ESecurityType.OptionType
def onPlayback_FuturesType_MD_TICK(mdFuture):
    pass
    # print(mdFuture)
...
def onPlayback_MD_TRANSACTION_and_MD_ORDER(marketdatajson):
    if marketdatajson["marketDataType"] == EMarketDataType.MD_TRANSACTION:  # 逐笔成交
        mdtransaction = marketdatajson["mdTransaction"]
        pass
        # print(mdtransaction)
...
def config(open_trace=True, open_file_log=True, open_cout_log=True):
    com.insight.common.config(open_trace, open_file_log, open_cout_log)
...
def subscribe_by_id():
    ...
    com.insight.subscribe.subscribe_by_id(HTSCSecurityIDs, datatype)
...
def query_mdcontant_type():
    ...
    com.insight.query.query_basicInfo_by_type(idsource_and_types, False)
...
def query_last_mdcontant_type():
    ...
    com.insight.query.query_basicInfo_by_type(idsource_and_types, True)
...
def play_back():
    ...
    com.insight.playback.playback(htscsecurityID_and_types, exrights_type, start_time, stop_time)
...
def play_back_oneday():
    ...
    # 特别注意！！！！
    # security_id_list 注意回放限制
    com.insight.playback.play_back_oneday(htscsecurityID_and_types, exrights_type, isMdtime)
