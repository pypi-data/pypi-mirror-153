...
def config(open_trace=True, open_file_log=True, open_cout_log=True):
    ...
    if open_file_log:
        com.data_handle.get_interface().python_open_file_log()
    else:
        com.data_handle.get_interface().python_close_file_log()
    if open_cout_log:
        com.data_handle.get_interface().python_open_cout_log()
    else:
        com.data_handle.get_interface().python_close_cout_log()
    if open_trace:
        com.data_handle.get_interface().python_open_trace()
    else:
        com.data_handle.get_interface().python_close_trace()
