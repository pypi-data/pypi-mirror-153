...
class StatesCatalogVocabularyIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_states_catalog_vocabulary(self):
        vocab_name = 'cs.volto.publiccontracts.StatesCatalogVocabulary'
