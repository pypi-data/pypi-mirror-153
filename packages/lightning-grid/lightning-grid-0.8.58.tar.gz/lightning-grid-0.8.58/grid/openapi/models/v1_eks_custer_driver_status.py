...
class V1EKSCusterDriverStatus(object):
    ...
    def __init__(self, bastion_ami: 'str' = None, builder_ami: 'str' = None, cpu_ami: 'str' = None, ecr_registry_id: 'str' = None, ecr_repository_uri: 'str' = None, fsx_sg_id: 'str' = None, gpu_ami: 'str' = None, gridlet_role_arn: 'str' = None, user_workload_role_arn: 'str' = None, vpc_id: 'str' = None, vpc_private_subnet_ids: 'list[str]' = None, vpc_public_subnet_ids: 'list[str]' = None, _configuration=None):  # noqa: E501
