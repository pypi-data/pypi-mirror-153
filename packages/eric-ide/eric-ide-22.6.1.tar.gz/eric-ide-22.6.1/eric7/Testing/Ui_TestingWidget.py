# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.6.1/eric/eric7/Testing/TestingWidget.ui'
#
...
class Ui_TestingWidget(object):
    def setupUi(self, TestingWidget):
        ...
        self.tabWidget = QtWidgets.QTabWidget(TestingWidget)
        ...
        self.venvLabel = QtWidgets.QLabel(self.parametersTab)
        self.venvLabel.setObjectName("venvLabel")
        self.gridLayout_3.addWidget(self.venvLabel, 0, 0, 1, 1)
        self.venvComboBox = QtWidgets.QComboBox(self.parametersTab)
        ...
        self.label = QtWidgets.QLabel(self.parametersTab)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 1, 0, 1, 1)
        self.frameworkComboBox = QtWidgets.QComboBox(self.parametersTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.versionsButton = QtWidgets.QToolButton(self.parametersTab)
        ...
        self.resultsGroupBox = QtWidgets.QGroupBox(self.resultsTab)
        ...
        self.statusLabel = QtWidgets.QLabel(self.resultsGroupBox)
        ...
        self.sbLabel = QtWidgets.QLabel(TestingWidget)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(TestingWidget)
        ...
        TestingWidget.setTabOrder(self.testComboBox, self.coverageCheckBox)
