...
**and You're good to Go!** You can also install with optional dependencies (orjson, uvloop) as outlined in [Install 
Guide]()https://polygon.readthedocs.io/en/latest/Getting-Started.html#installing-polygon 
