...
- value (boolean | number | string | dict | list; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, schema=Component.REQUIRED, value=Component.UNDEFINED, uiSchema=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'n_clicks', 'schema', 'uiSchema', 'value']
        self._type = 'DashRjsf'
        self._namespace = 'dash_rjsf'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'n_clicks', 'schema', 'uiSchema', 'value']
