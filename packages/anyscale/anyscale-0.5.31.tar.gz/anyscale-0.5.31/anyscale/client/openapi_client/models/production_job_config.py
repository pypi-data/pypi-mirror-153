...
class ProductionJobConfig(object):
    ...
    def __init__(self, entrypoint=None, runtime_env=None, build_id=None, compute_config_id=None, max_retries=5, runtime_env_config=None, local_vars_configuration=None):  # noqa: E501
