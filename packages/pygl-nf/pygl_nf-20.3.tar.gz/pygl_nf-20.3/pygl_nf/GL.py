...
def Get_pyGL_Version():
    print(colorama.Fore.BLUE+'Pygl version (20.3)'+colorama.Fore.RESET)
...
class Particles():
    ...
    class Area():
        class Rect():
            def __init__(self,surf,rect,shape_data,color_randoming=False,color_index=0,circle_speed = 1,vector_speed = [],size_deller = 1,return_size=False, size_resize = True, particle_count = 5, max_particle = 300, dell_count = 100, gravity=[], life_time = 2, life_dell_count=5 ,life_delta = 0.1, spawn_time=5, spawn_delta=0.1) -> None:
                self.rect = rect
                ...
                if self.return_size:
                    ...
                    self.shape_widt = self.shape_data[1]
            ...
            def Emiter(self):
                ...
                if self.time%self.spawn_time==0:
                    for i in range(self.partcle_count):
                        ...
                        particle = [pos,self.cirkul_speed,self.shape_widt,self.vector_spee,self.life_time,color]
