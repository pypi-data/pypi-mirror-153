...
class DatasetStats(google.protobuf.message.Message):
    ...
    class Column(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["max",b"max","mean",b"mean","min",b"min","name",b"name","not_null_count",b"not_null_count","null_count",b"null_count","std",b"std"]) -> None: ...
