...
class Document(dict):
    ...
    def __init__(self, data=None, **kwargs):
        super().__init__()
        # We want to be able to either pass in a dict or the attributes as keyword arguments
        if data is None:
            data = kwargs
...
def create_collection_class(class_name: str, collection_name: Union[str, None] = None) -> Document:
    """
