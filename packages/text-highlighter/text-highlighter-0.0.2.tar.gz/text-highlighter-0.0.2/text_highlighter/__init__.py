...
def text_highlighter(text='Hello world!', annotations=[], labels=['PERSON', 'ORG'], colors=None, key=None):
    ...
    component_value = _component_func(text=text, annotations=annotations, colors=colors, labels=labels, key=key, default=annotations)
...
if not _RELEASE:
    ...
    value = text_highlighter(text='Hello world! This is a demo.', annotations=annotations, labels='PERSON')
    st.write(value)
