...
def load_data(connector, batch, good_object_id, mapping_object, _replace, request, batch_size):
    total_batches = (request.param * GB) / batch_size
    batch_number = 1
...
def mapping_object():
    return [
        {'source_field_id': "First", 'destination_field_id': "newfirst", 'datatype': None, 'size': None},
        {'source_field_id': "Last", 'destination_field_id': "newlast", 'datatype': None, 'size': None},
        {'source_field_id': "Gender", 'destination_field_id': "newgender", 'datatype': None, 'size': None},
        {'source_field_id': "BirthDate", 'destination_field_id': "newbirthdate", 'datatype': None, 'size': None},
        {'source_field_id': "StartDate", 'destination_field_id': "newstartdate", 'datatype': None, 'size': None}
    ]
