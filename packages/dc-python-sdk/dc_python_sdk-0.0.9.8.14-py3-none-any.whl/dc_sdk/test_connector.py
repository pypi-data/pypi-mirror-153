...
class TestLoadData:
    ...
    def test_load_data_append(self, connector, good_object_id, m, _append, five_column_dataset):
        try:
            connector.load_data(five_column_dataset, good_object_id, m, _append, batch_number=1, total_batches=1)
    ...
    def test_load_data_replace(self, connector, good_object_id, m, _replace, five_column_dataset):
        try:
            connector.load_data(five_column_dataset, good_object_id, m, _replace, batch_number=1, total_batches=1)
        except Exception as e:
    ...
    def test_load_data_create_new_table(self, connector, bad_object_id, m, _replace, five_column_dataset):
        ...
        connector.load_data(five_column_dataset, bad_object_id, m, _replace, batch_number=1, total_batches=1)
        connector.authenticate()
