...
class TestLoadData:
    ...
    def test_load_data_append(self, connector, good_object_id, mapping_object, _append, five_column_dataset):
        try:
            connector.load_data(five_column_dataset,
                                good_object_id,
                                mapping_object,
                                _append,
                                batch_number=1,
    ...
    @pytest.mark.destination
    @pytest.mark.load_data
    def test_load_data_replace(self, connector, good_object_id, mapping_object, _replace, five_column_dataset):
        try:
            connector.load_data(five_column_dataset,
                                good_object_id,
                                mapping_object,
