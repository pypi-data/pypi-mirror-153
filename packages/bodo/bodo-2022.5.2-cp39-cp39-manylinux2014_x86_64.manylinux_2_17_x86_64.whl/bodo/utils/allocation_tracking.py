...
def get_allocation_stats():
    audkm__uyan = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    wzg__vyfxs, acp__lycf, voa__yahm, rbji__iofgl = 0, 0, 0, 0
    for yti__jyre in audkm__uyan:
        wzg__vyfxs += yti__jyre[0]
        acp__lycf += yti__jyre[1]
        voa__yahm += yti__jyre[2]
        rbji__iofgl += yti__jyre[3]
    return wzg__vyfxs, acp__lycf, voa__yahm, rbji__iofgl
