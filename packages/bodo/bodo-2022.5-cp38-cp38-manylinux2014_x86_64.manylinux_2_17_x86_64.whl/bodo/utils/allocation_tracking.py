...
def get_allocation_stats():
    vymc__tlcvd = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    lop__thd, ccg__fqnej, ujxv__ftpz, lbafb__yri = 0, 0, 0, 0
    for fvisy__nofu in vymc__tlcvd:
        lop__thd += fvisy__nofu[0]
        ccg__fqnej += fvisy__nofu[1]
        ujxv__ftpz += fvisy__nofu[2]
        lbafb__yri += fvisy__nofu[3]
    return lop__thd, ccg__fqnej, ujxv__ftpz, lbafb__yri
