...
def get_allocation_stats():
    ocid__ipx = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    wojs__efak, nwflp__fax, lvc__phv, ednp__xiwtc = 0, 0, 0, 0
    for ifky__mghq in ocid__ipx:
        wojs__efak += ifky__mghq[0]
        nwflp__fax += ifky__mghq[1]
        lvc__phv += ifky__mghq[2]
        ednp__xiwtc += ifky__mghq[3]
    return wojs__efak, nwflp__fax, lvc__phv, ednp__xiwtc
