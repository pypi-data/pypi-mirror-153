...
is_standalone_build = not os.path.exists('/home/even/gdal/3.5/build/swig/python')

if is_standalone_build:
    include_dirs = []
    library_dirs = []
else:
    include_dirs = ['/home/even/gdal/3.5/build/port', '/home/even/gdal/3.5/port', '/home/even/gdal/3.5/build/gcore', '/home/even/gdal/3.5/gcore', '/home/even/gdal/3.5/alg', '/home/even/gdal/3.5/ogr/', '/home/even/gdal/3.5/ogr/ogrsf_frmts', '/home/even/gdal/3.5/gnm', '/home/even/gdal/3.5/apps']
    library_dirs = ['/home/even/gdal/3.5/build']
libraries = ['gdal']
