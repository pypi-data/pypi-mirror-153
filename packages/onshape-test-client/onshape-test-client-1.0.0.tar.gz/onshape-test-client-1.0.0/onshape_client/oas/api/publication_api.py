...
class PublicationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_publication_items_endpoint = _Endpoint(
            settings={
                'response_type': ([Item],),
                'auth': [
                    'BasicAuth',
                ...
                'endpoint_path': '/publications/{pid}/items',
                'operation_id': 'get_publication_items',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_publication_items(
        self,
        pid,
        **kwargs
    ):
        """get_publication_items  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_publication_items(pid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pid'] = \
            pid
        return self.get_publication_items_endpoint.call_with_http_info(**kwargs)
