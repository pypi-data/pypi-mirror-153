...
class ExportRuleApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_valid_rule_options_endpoint = _Endpoint(
            settings={
                'response_type': (BTExportRuleValidOptionsInfo,),
                'auth': [
                    'BasicAuth',
                    'OAuth2'
                ],
                'endpoint_path': '/exportrules/options/{otype}/{oid}',
                'operation_id': 'get_valid_rule_options',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_valid_rule_options(
        self,
        otype,
        oid,
        **kwargs
    ):
        """get_valid_rule_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_valid_rule_options(otype, oid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['oid'] = \
            oid
        return self.get_valid_rule_options_endpoint.call_with_http_info(**kwargs)
