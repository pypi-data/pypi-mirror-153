...
class VersionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.test_versions_get_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/versions/test',
        ...
        self.test_versions_post_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'BasicAuth'
    ...
    def test_versions_get(
        ...
        **kwargs
        ...
        return self.test_versions_get_endpoint.call_with_http_info(**kwargs)

    def test_versions_post(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.test_versions_post_endpoint.call_with_http_info(**kwargs)
