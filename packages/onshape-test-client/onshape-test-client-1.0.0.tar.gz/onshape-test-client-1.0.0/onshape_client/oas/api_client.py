...
from onshape_client.oas.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = APIApplicationApi()
        api_instance.delete_app_settings  # this is an instance of the class Endpoint
        api_instance.delete_app_settings()  # this invokes api_instance.delete_app_settings.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_app_settings.callable or self.callable in this class
