...
class BTDocumentSelectorParametersInfo(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'BTOtherDocumentSelectorParametersInfo': BTOtherDocumentSelectorParametersInfo,
    ...
    def _from_openapi_data(cls, json_type, *args, **kwargs):  # noqa: E501
        """BTDocumentSelectorParametersInfo - a model defined in OpenAPI
