...
def lazy_import():
    ...
    globals()['BTDocumentProcessingInfo'] = BTDocumentProcessingInfo
    globals()['BTDocumentProcessingInfoAllOf'] = BTDocumentProcessingInfoAllOf
...
class BTDocumentProcessingInfo(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'document-processing': BTDocumentProcessingInfo,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BTDocumentProcessingInfo - a model defined in OpenAPI
