...
class NotificationForm(forms.ModelForm):
    recipient = EmailLookup(reverse_lazy('search_email'), label=_('Recipient list'))
    bcc = EmailLookup(reverse_lazy('search_email'), label=_('Bcc Recipient list'), required=False)
    cc = EmailLookup(reverse_lazy('search_email'), label=_('CC Recipient list'), required=False)
