...
import pyttsx3, speech_recognition as sr, random
...
class voice_assistant:
    ...
    # define the say greeting function

    def say_greeting(self):

        # create the greetings list

        greetings = ["Hi", "Hello", "Hey", "Greetings", "How's it going"]
