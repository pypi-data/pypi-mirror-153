...
class ConfigClient(object):
    ...
    def create_config(self, apm_domain_id, create_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.70.0/apmconfig/create_config.py.html>`__ to see an example of how to use create_config API.
        """
    ...
    def delete_config(self, apm_domain_id, config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.70.0/apmconfig/delete_config.py.html>`__ to see an example of how to use delete_config API.
        """
    ...
    def get_config(self, apm_domain_id, config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.70.0/apmconfig/get_config.py.html>`__ to see an example of how to use get_config API.
        """
        resource_path = "/configs/{configId}"
        method = "GET"
    ...
    def list_configs(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.70.0/apmconfig/list_configs.py.html>`__ to see an example of how to use list_configs API.
        """
        resource_path = "/configs"
        method = "GET"
    ...
    def update_config(self, apm_domain_id, config_id, update_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.70.0/apmconfig/update_config.py.html>`__ to see an example of how to use update_config API.
        """
        resource_path = "/configs/{configId}"
        method = "PUT"
