...
def install(
    ...
    secrets: JslSecrets = JslSecrets.build_or_try_find_secrets(access_token, email, passw,
...
def start(
    ...
    secrets: Union[JslSecrets, bool] = JslSecrets.build_or_try_find_secrets(access_token, email, passw, secrets_file,
                                                                            hc_license,
                                                                            hc_secret,
