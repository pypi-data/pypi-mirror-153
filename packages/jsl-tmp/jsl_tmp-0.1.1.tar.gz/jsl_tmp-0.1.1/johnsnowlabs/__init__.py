...
from johnsnowlabs.utils.lib_resolvers import try_import_lib, is_spark_version_env
...
def start(nlp=True, hc=False, ocr=False, gpu=False, hc_secret=None, ocr_secret=None,
    ...
    from johnsnowlabs.utils.lib_resolvers import NlpLibResolver, HcLibResolver, OcrLibResolver
    if secrets_file:
