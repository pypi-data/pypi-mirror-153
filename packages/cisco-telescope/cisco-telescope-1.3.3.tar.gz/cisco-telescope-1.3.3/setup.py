...
['Flask>=2.1.2,<3.0.0',
 ...
 'opentelemetry-distro>=0.30b1,<0.31',
 ...
 'opentelemetry-instrumentation-aiohttp-client>=0.30b1,<0.31',
 'opentelemetry-instrumentation-fastapi>=0.30b1,<0.31',
 'opentelemetry-instrumentation-flask>=0.30b1,<0.31',
 'opentelemetry-instrumentation-grpc>=0.30b1,<0.31',
 'opentelemetry-instrumentation-httpx>=0.30b1,<0.31',
 'opentelemetry-instrumentation-requests>=0.30b1,<0.31',
 'opentelemetry-sdk==1.11.1',
 'opentelemetry-util-http>=0.30b1,<0.31',
