...
def reform_table(last_valuation_table, valuation_table, holding_info):
    ...
    if '净值日期' in last_valuation_table.columns and '单位净值' in last_valuation_table.columns and '收益率' in last_valuation_table.columns:
    ...
    if '净值日期' in last_valuation_table.columns and '单位净值' in last_valuation_table.columns and '收益率' in last_valuation_table.columns:
        ...
        reformed_valuation_table = holding
