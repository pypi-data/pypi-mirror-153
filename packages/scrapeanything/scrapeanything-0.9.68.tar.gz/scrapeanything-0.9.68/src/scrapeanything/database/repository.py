...
class Repository:
    ...
    def __init__(self, config: Config) -> None:
        ...
        username = os.environ['MYSQL_USER'] # self.config.get(section='DATABASE', key='username')
        password = os.environ['MYSQL_PASSWORD'] # self.config.get(section='DATABASE', key='password')
        host = os.environ['MYSQL_HOST'] # self.config.get(section='DATABASE', key='host')
        port = os.environ['MYSQL_PORT'] # self.config.get(section='DATABASE', key='port')
        database = os.environ['MYSQL_DATABASE'] # self.config.get(section='DATABASE', key='database')
