...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of collibra_catalog.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = collibra_catalog.Configuration(
    ...
    Note you can use the constants defined in the collibra_catalog.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = collibra_catalog.Configuration(
        signing_info = collibra_catalog.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
