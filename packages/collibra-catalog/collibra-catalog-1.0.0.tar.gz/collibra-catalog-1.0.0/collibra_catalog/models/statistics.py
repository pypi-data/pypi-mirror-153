...
class Statistics(object):
    ...
    def __init__(self, mean=None, variance=None, standard_deviation=None, minimum=None, maximum=None, minimum_text_length=None, maximum_text_length=None, local_vars_configuration=None):  # noqa: E501
