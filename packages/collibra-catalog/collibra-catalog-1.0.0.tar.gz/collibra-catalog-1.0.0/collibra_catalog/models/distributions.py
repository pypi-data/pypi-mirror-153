...
class Distributions(object):
    ...
    def __init__(self, distribution_density_estimation=None, histogram=None, local_vars_configuration=None):  # noqa: E501
        """Distributions - a model defined in OpenAPI"""  # noqa: E501
