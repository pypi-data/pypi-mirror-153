...
class DatabaseMetadata(object):
    ...
    def __init__(self, default_value=None, number_of_decimal_digits=None, char_octet_length=None, column_size=None, primary_key_name=None, is_nullable=None, is_auto_incremented=None, is_generated=None, is_primary_key=None, local_vars_configuration=None):  # noqa: E501
        """DatabaseMetadata - a model defined in OpenAPI"""  # noqa: E501
