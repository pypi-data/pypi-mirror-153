...
class AddSchemaFromJdbcRequest(object):
    ...
    def __init__(self, schema_name=None, jdbc_driver_id=None, properties=None, user=None, password=None, jdbc_connection_string=None, description=None, owner_id=None, store_credentials=None, cron_expression=None, cron_time_zone=None, extract_data_sample=None, execute_profiling=None, detect_advanced_data_types=None, tables_to_skip=None, job_server=None, local_vars_configuration=None):  # noqa: E501
        """AddSchemaFromJdbcRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def jdbc_driver_id(self, jdbc_driver_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and jdbc_driver_id is None:  # noqa: E501
