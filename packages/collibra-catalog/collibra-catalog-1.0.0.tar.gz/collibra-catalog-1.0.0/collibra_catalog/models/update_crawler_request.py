...
class UpdateCrawlerRequest(object):
    ...
    def __init__(self, name=None, include_paths=None, crawler_id=None, domain_id=None, local_vars_configuration=None):  # noqa: E501
        """UpdateCrawlerRequest - a model defined in OpenAPI"""  # noqa: E501
