...
from collibra_catalog.models.crawler_include_path import CrawlerIncludePath  # noqa: E501
...
class TestCrawlerIncludePath(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = collibra_catalog.models.crawler_include_path.CrawlerIncludePath()  # noqa: E501
        if include_optional :
            return CrawlerIncludePath(
                path = '0', 
                exclude_patterns = [
                    '0'
                    ]
