...
from collibra_catalog.models.crawler import Crawler  # noqa: E501
...
class TestCrawler(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = collibra_catalog.models.crawler.Crawler()  # noqa: E501
        if include_optional :
            return Crawler(
                crawler_id = '0', 
                name = '0', 
                include_paths = [
                    collibra_catalog.models.crawler_include_path.CrawlerIncludePath(
                        path = '0', 
                        exclude_patterns = [
                            '0'
                            ], )
