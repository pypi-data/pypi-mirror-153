...
class ArtifactEditForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Short description", labelFor: "artifact-short-description", labelInfo: "(required)" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { id: "artifact-short-description", placeholder: "A short description of your experiment", required: true, value: this.props.artifact.short_description, onChange: this.props.onChange('short_description') })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Long description", labelFor: "chi-artifact-long-description", helperText: "Supports GitHub-flavored markdown" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.TextArea, { id: "chi-artifact-long-description", fill: true, growVertically: true, value: this.props.artifact.long_description, onChange: this.props.onChange("long_description") })));
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.a86277e758c778e3b94c.js.map