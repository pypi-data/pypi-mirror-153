...
class ArtifactRegistry {
    ...
    async createContents(path) {
        // Upload experiment contents (located at `path`)
        const res = await _jupyterlab_services__WEBPACK_IMPORTED_MODULE_0__.ServerConnection.makeRequest(Private.getContentsUrl(this._serverSettings), { method: 'POST', body: JSON.stringify({ path }) }, this._serverSettings);
    ...
    async commitArtifact(artifact) {
        const res = await _jupyterlab_services__WEBPACK_IMPORTED_MODULE_0__.ServerConnection.makeRequest(Private.getArtifactsUrl(this._serverSettings), { method: 'PUT', body: JSON.stringify(artifact) }, this._serverSettings);
...
(function (Private) {
    ...
    function getArtifactsUrl(settings) {
        ...
        return _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_1__.URLExt.join.call(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_1__.URLExt, ...parts) + "?op=list";
    }
...
/* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tokens */ "./lib/artifact-sharing/tokens.js");
...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("ul", null, this.getListForComponents().map((item, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { key: index },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("li", null, this.props.newComponentGenerator(item, this.updateItem(index), this.props.disabled)),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("button", { type: "button", onClick: this.addItem(index), disabled: this.props.disabled }, "+"),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("button", { type: "button", onClick: this.removeItem(index), disabled: this.props.disabled }, "-"))))));
    }
}
class ArtifactAuthorComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    constructor(props) {
        super(props);
    }
    hasAnyInput() {
    ...
    render() {
        const author = this.props.author;
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "authorInput" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Full Name"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "author_full_name", type: "text", placeholder: "The author's full name", required: this.hasAnyInput(), value: author.full_name, onChange: this.props.onFieldChange("full_name"), disabled: this.props.disabled })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "E-Mail Address"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "author_email", type: "email", placeholder: "The author's e-mail address", required: this.hasAnyInput(), value: author.email, onChange: this.props.onFieldChange("email"), disabled: this.props.disabled })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Affiliation"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "author_affiliation", type: "text", placeholder: "The organization or group with which the author is affiliated", value: author.affiliation, onChange: this.props.onFieldChange("affiliation"), disabled: this.props.disabled }))));
    }
}
...
//   }
// }
class ArtifactLinkComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    constructor(props) {
        super(props);
    }
    isAnythingSet() {
    ...
    render() {
        const link = this.props.link;
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "linkInput" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "URN"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "link_urn", type: "text", placeholder: "A URN string describing the link", required: this.isAnythingSet(), value: link.urn, onChange: this.props.onFieldChange("urn") })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Label"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "link_label", type: "text", placeholder: "A label which describes the link's content", required: this.isAnythingSet(), value: link.label, onChange: this.props.onFieldChange("label") }))));
    }
}
class ArtifactEditForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    isCreateForm() {
        return this.props.artifact.id === null || this.props.artifact.id === undefined;
    }
    visibleOnlyOnNewVersion() {
        return this.props.artifact.id ? ArtifactEditForm.block : ArtifactEditForm.hidden;
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", { onSubmit: this.props.onSubmit, style: this.props.formVisibility },
            this.props.error && (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-ErrorMessage" }, this.props.error)),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("fieldset", { id: "artifactFormInputs" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", { style: this.visibleOnlyOnNewVersion() },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "ID"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "id", type: "text", value: this.props.artifact.id, alt: "The UUID used to reference this artifact", disabled: true })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { className: "chi-ArtifactSharing-Form-Required" }, "Title"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "title", type: "text", placeholder: "The title of your experiment", required: true, onChange: this.props.onChange("title"), disabled: !this.isCreateForm() })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { className: "chi-ArtifactSharing-Form-Required" }, "Short Description"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "short_description", type: "text", placeholder: "A short description of your experiment", required: true, onChange: this.props.onChange("short_description"), disabled: !this.isCreateForm() })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Long Description"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("textarea", { name: "long_description", placeholder: "Long description of your experiment. Supports GitHub-flavored markdown (Optional)", onChange: this.props.onChange("long_description"), disabled: !this.isCreateForm() })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Visibility"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("select", { name: "visibility", title: "Allow other users to view your artifact", defaultValue: _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PRIVATE, onChange: this.props.onChange("visibility"), disabled: !this.isCreateForm() },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("option", { value: _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PRIVATE }, "private"),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("option", { value: _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PUBLIC }, "public"))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("h3", null, "Authors"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { artifactUpdater: this.props.onListChange("authors"), newComponentGenerator: (item, updater, disabled) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactAuthorComponent, { author: item, onFieldChange: updater, disabled: disabled }), newObjectGenerator: () => ({ full_name: "", email: "", affiliation: "" }), list: [...this.props.artifact.authors], disabled: !this.isCreateForm() })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("h3", null, "Links"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { artifactUpdater: this.props.onListChange("newLinks"), newComponentGenerator: (item, updater) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactLinkComponent, { link: item, onFieldChange: updater }), newObjectGenerator: () => ({ urn: "", label: "" }), list: [...this.props.artifact.newLinks] }))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("button", { name: "artifact-Form-Submit", type: "submit" }, this.props.artifact.id ? "Save Changes" : "Create Artifact")));
    }
}
...
class ArtifactSharingComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
        ...
        if (payload.body.status === 'success') {
            ...
            if (this.props.workflow === 'upload') {
                ...
                if (isNewOwnedArtifact) {
                    const artifact = Object.assign({}, this.state.artifact);
                    try {
    ...
    async onSubmit(event) {
        ...
        this.setState({
            ...
            waitMessage: "Please wait while we upload your files"
        });
        if (previousState === WidgetState.CONFIRM_FORM) {
            // After the confirm form, we upload the state of the experiment
            try {
                const contents = await this.props.artifactRegistry.createContents(this.state.artifact.path);
                this.setState({
                    currentState: WidgetState.ARTIFACT_FORM,
                    artifact: Object.assign(Object.assign({}, this.state.artifact), { newContents: contents })
                });
            }
            catch (e) {
                this.setState({
            ...
            try {
                if (this.state.artifact.id) {
                    ...
                    artifact = Object.assign(Object.assign({}, this.state.artifact), { versions: [...this.state.artifact.versions, version] });
                }
                else {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-Expand" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-FormActions" },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("button", { className: "jp-mod-styled jp-mod-accept", type: "submit" },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement("code", null,
                                ...
                                "/"))))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-Form", style: visibilities[WidgetState.ARTIFACT_FORM] }, this.state.currentState === WidgetState.ARTIFACT_FORM && (react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactEditForm, { artifact: this.state.artifact, formVisibility: visibilities[WidgetState.ARTIFACT_FORM], onChange: this.handleChange, onListChange: this.handleListChange, onSubmit: this.onSubmit, error: this.state.errorMessage }))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-Form", style: visibilities[WidgetState.WAITING] },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "jp-Spinner" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-LoadingMessage" }, this.state.waitMessage))),
...
//# sourceMappingURL=lib_index_js.34913914fb5f035ce1ac.js.map