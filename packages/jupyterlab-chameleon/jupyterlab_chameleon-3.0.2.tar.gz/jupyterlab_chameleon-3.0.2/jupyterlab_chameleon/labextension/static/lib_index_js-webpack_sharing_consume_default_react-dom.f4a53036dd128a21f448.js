...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null, this.getListForComponents().map((item, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { key: index },
            this.props.newComponentGenerator(item, this.updateItem(index), this.props.disabled),
...
class ArtifactAuthorComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        const author = this.props.author;
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.ControlGroup, null,
...
class ArtifactEditForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Long description", labelFor: "artifact-long-description", helperText: "Supports GitHub-flavored markdown" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.TextArea, { id: "artifact-long-description", value: this.props.artifact.long_description, onChange: this.props.onChange("long_description") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Visibility", labelFor: "artifact-visibility" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.HTMLSelect, { id: "artifact-visibility", title: "Allow other users to view your artifact", defaultValue: this.props.artifact.visibility, onChange: this.props.onChange("visibility") },
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.f4a53036dd128a21f448.js.map