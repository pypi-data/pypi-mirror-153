...
class ArtifactEditForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { label: 'Authors', helperText: 'List any individuals you would like to credit. This is purely for display '
                    + 'purposes and does not control who is able to edit the artifact.', artifactUpdater: this.props.onListChange("authors"), newComponentGenerator: (item, onFieldChange, onDelete) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactAuthorComponent, { author: item, onFieldChange: onFieldChange, onDelete: onDelete }), newObjectGenerator: () => ({ full_name: "", email: "", affiliation: "" }), list: [...this.props.artifact.authors] }));
            /**
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.46f644083247ded057e3.js.map