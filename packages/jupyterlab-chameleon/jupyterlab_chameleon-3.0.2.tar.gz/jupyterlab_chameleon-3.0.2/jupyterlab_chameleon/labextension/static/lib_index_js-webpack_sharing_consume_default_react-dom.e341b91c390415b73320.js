...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { className: 'chi-ListComponent', label: this.props.label, labelInfo: this.props.labelInfo, helperText: this.props.helperText },
            this.getListForComponents().map((item, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: 'chi-ListComponent-Item', key: index }, this.props.newComponentGenerator(item, this.updateItem(index), this.removeItem(index))))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { small: true, onClick: this.addItem(), icon: 'plus' }, "Add author")));
    }
}
class ArtifactAuthorComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.ControlGroup, { fill: true },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { placeholder: 'Full name', required: this.hasAnyInput(), value: author.full_name, onChange: this.props.onFieldChange('full_name') }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { placeholder: 'Email address', required: this.hasAnyInput(), value: author.email, onChange: this.props.onFieldChange('email') }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { placeholder: 'Affiliation', required: this.hasAnyInput(), value: author.affiliation, onChange: this.props.onFieldChange('affiliation') }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { icon: 'trash', small: true, onClick: onDelete }, "Delete"))
...
class ArtifactEditForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Title", labelFor: "chi-ArtifactForm-title", labelInfo: "(required)" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { id: "chi-ArtifactForm-title", required: true, placeholder: "The title of your experiment", value: this.props.artifact.title, onChange: this.props.onChange("title") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Short description", labelFor: "chi-ArtifactForm-short-description", labelInfo: "(required)" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { id: "chi-ArtifactForm-short-description", placeholder: "A short description of your experiment", required: true, value: this.props.artifact.short_description, onChange: this.props.onChange('short_description') })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Long description", labelFor: "chi-ArtifactForm-long-description", helperText: "Supports GitHub-flavored markdown" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.TextArea, { id: "chi-ArtifactForm-long-description", fill: true, growVertically: true, style: { minHeight: '5rem' }, value: this.props.artifact.long_description, onChange: this.props.onChange("long_description") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Visibility", labelFor: "chi-ArtifactForm-visibility" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.HTMLSelect, { id: "chi-ArtifactForm-visibility", title: "Allow other users to view your artifact", defaultValue: this.props.artifact.visibility, onChange: this.props.onChange("visibility") },
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { label: 'Authors', helperText: 'List any individuals you would like to credit. This is purely for display purposes and does not control who is able to edit the artifact.', artifactUpdater: this.props.onListChange("authors"), newComponentGenerator: (item, onFieldChange, onDelete) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactAuthorComponent, { author: item, onFieldChange: onFieldChange, onDelete: onDelete }), newObjectGenerator: () => ({ full_name: "", email: "", affiliation: "" }), list: [...this.props.artifact.authors] }));
            /**
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", { onSubmit: this.props.onSubmit, style: this.props.formVisibility },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-FormActions" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { type: 'submit', large: true }, submitText))));
    }
}
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.e341b91c390415b73320.js.map