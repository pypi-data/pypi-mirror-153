...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
            this.getListForComponents().map((item, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { key: index }, this.props.newComponentGenerator(item, this.updateItem(index), this.removeItem(index), this.props.disabled)))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { onClick: this.addItem(), disabled: this.props.disabled, icon: 'plus' }, "Add author")));
    }
}
class ArtifactAuthorComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.ControlGroup, { fill: true },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { icon: 'trash', onClick: onDelete }, "Delete"))
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { artifactUpdater: this.props.onListChange("authors"), newComponentGenerator: (item, updater, deleter, disabled) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactAuthorComponent, { author: item, onFieldChange: updater, onDelete: deleter, disabled: disabled }), newObjectGenerator: () => ({ full_name: "", email: "", affiliation: "" }), list: [...this.props.artifact.authors] })));
            /**
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.522e7b935fb322d40859.js.map