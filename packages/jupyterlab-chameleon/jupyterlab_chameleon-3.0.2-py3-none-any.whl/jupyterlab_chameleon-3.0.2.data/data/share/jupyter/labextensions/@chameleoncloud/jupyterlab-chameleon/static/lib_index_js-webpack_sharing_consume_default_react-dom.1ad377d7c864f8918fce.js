...
/* harmony export */ });
/* harmony import */ var _blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @blueprintjs/core */ "./node_modules/@blueprintjs/core/lib/esm/components/index.js");
/* harmony import */ var _blueprintjs_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @blueprintjs/core */ "./node_modules/@blueprintjs/core/lib/esm/common/classes.js");
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
            ...
            this.props.artifact && (react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null,
                ...
                ' ',
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: this.props.urlFactory.detailUrl(this.props.artifact.uuid), target: "_blank", rel: "noreferrer" }, "Trovi"),
                ".")),
...
class EditArtifactText extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("h2", null, "Edit artifact")));
    }
}
class EditArtifactSuccessText extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("h2", null, "Your artifact has been updated."),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "You may now close this window.")));
    }
}
...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("ul", null, this.getListForComponents().map((item, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { key: index },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null, this.props.newComponentGenerator(item, this.updateItem(index), this.props.disabled)),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.ButtonGroup, { minimal: true },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { onClick: this.addItem(index), disabled: this.props.disabled, text: "+" }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.Button, { onClick: this.removeItem(index), disabled: this.props.disabled, text: "-" })))))));
    }
}
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "authorInput" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "author_full_name", type: "text", className: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_4__.INPUT, placeholder: "The author's full name", required: this.hasAnyInput(), value: author.full_name, onChange: this.props.onFieldChange("full_name"), disabled: this.props.disabled })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "E-Mail Address"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "author_email", type: "email", className: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_4__.INPUT, placeholder: "The author's e-mail address", required: this.hasAnyInput(), value: author.email, onChange: this.props.onFieldChange("email"), disabled: this.props.disabled })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Affiliation"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "author_affiliation", type: "text", className: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_4__.INPUT, placeholder: "The organization or group with which the author is affiliated", value: author.affiliation, onChange: this.props.onFieldChange("affiliation"), disabled: this.props.disabled }))));
    }
}
...
class ArtifactEditForm extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        if (this.isUploadForm()) {
            submitText = react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", null,
                "Upload: ",
            ...
            submitText = react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", null, "Save");
        }
        if (!this.isNewVersionForm()) {
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { label: "Title", labelFor: "artifact-title", labelInfo: "(required)" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.InputGroup, { id: "artifact-title", required: true, placeholder: "The title of your experiment", value: this.props.artifact.title, onChange: this.props.onChange("title") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { className: "chi-ArtifactSharing-Form-Required" }, "Short Description"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "short_description", type: "text", className: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_4__.INPUT, placeholder: "A short description of your experiment", required: true, value: this.props.artifact.short_description, onChange: this.props.onChange("short_description") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Long Description"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("textarea", { name: "long_description", className: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_4__.INPUT, placeholder: "Long description of your experiment. Supports GitHub-flavored markdown (Optional)", value: this.props.artifact.long_description, onChange: this.props.onChange("long_description") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Visibility"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.HTMLSelect, { name: "visibility", title: "Allow other users to view your artifact", defaultValue: this.props.artifact.visibility, onChange: this.props.onChange("visibility") },
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { artifactUpdater: this.props.onListChange("authors"), newComponentGenerator: (item, updater, disabled) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactAuthorComponent, { author: item, onFieldChange: updater, disabled: disabled }), newObjectGenerator: () => ({ full_name: "", email: "", affiliation: "" }), list: [...this.props.artifact.authors] })));
            /**
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", { onSubmit: this.props.onSubmit, style: this.props.formVisibility },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-FormActions" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("button", { className: "jp-mod-styled jp-mod-accept", type: "submit" }, submitText))));
    }
}
...
class ArtifactSharingComponent extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        ...
        if (this.props.workflow === 'upload') {
            ...
            formText = react__WEBPACK_IMPORTED_MODULE_1__.createElement(EditArtifactText, { urlFactory: this.props.urlFactory });
            successText = (react__WEBPACK_IMPORTED_MODULE_1__.createElement(EditArtifactSuccessText, { urlFactory: this.props.urlFactory, artifact: this.state.artifact }));
        }
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-Expand" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "chi-ArtifactSharing-Form", style: visibilities[WidgetState.ARTIFACT_FORM] }, this.state.currentState === WidgetState.ARTIFACT_FORM && (react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactEditForm, { artifact: this.state.artifact, workflow: this.props.workflow, formVisibility: visibilities[WidgetState.ARTIFACT_FORM], formText: formText, onChange: this.handleChange, onListChange: this.handleListChange, onSubmit: this.onSubmit, error: this.state.errorMessage }))),
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.1ad377d7c864f8918fce.js.map