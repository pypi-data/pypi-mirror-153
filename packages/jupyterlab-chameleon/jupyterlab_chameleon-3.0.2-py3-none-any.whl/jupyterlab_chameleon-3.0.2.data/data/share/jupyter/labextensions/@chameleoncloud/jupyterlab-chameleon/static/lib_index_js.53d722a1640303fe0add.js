    ...
    async onSubmit(event) {
        ...
        try {
            if (this.state.artifact.id) {
                ...
                // FIXME: this type of local state syncing should be abstracted from the component
            ...
            // FIXME: this should happen as part of create/new
...
//# sourceMappingURL=lib_index_js.53d722a1640303fe0add.js.map