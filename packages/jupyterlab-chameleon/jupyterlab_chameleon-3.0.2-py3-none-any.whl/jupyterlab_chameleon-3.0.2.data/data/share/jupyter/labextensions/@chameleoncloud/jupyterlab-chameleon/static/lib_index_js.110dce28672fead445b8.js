...
class ArtifactRegistry {
    ...
    async updateArtifact(artifact) {
        ...
        const res = await _jupyterlab_services__WEBPACK_IMPORTED_MODULE_0__.ServerConnection.makeRequest(Private.getArtifactsUrl(this._serverSettings), { method: 'PUT', body: JSON.stringify(patchList) }, this._serverSettings);
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "title", type: "text", placeholder: "The title of your experiment", required: true, value: this.props.artifact.title, onChange: this.props.onChange("title") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { className: "chi-ArtifactSharing-Form-Required" }, "Short Description"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { name: "short_description", type: "text", placeholder: "A short description of your experiment", required: true, value: this.props.artifact.short_description, onChange: this.props.onChange("short_description") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Long Description"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("textarea", { name: "long_description", placeholder: "Long description of your experiment. Supports GitHub-flavored markdown (Optional)", value: this.props.artifact.long_description, onChange: this.props.onChange("long_description") })));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", null, "Visibility"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("select", { name: "visibility", title: "Allow other users to view your artifact", defaultValue: _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PRIVATE, onChange: this.props.onChange("visibility") },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("option", { value: _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PRIVATE, selected: this.props.artifact.visibility === _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PRIVATE }, "private"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("option", { value: _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PUBLIC, selected: this.props.artifact.visibility === _tokens__WEBPACK_IMPORTED_MODULE_2__.ArtifactVisibility.PUBLIC }, "public"))));
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
...
//# sourceMappingURL=lib_index_js.110dce28672fead445b8.js.map