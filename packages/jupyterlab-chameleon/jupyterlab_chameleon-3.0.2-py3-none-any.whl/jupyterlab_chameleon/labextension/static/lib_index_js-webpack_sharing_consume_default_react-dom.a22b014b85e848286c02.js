...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: 'chi-ListComponent-Item' },
            this.getListForComponents().map((item, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { key: index }, this.props.newComponentGenerator(item, this.updateItem(index), this.removeItem(index))))),
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.a22b014b85e848286c02.js.map