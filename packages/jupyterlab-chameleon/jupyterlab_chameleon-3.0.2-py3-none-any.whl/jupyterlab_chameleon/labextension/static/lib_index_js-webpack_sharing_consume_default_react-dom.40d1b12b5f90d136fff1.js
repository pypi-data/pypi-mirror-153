...
class ArtifactDynamicLengthList extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__.FormGroup, { className: 'chi-ListComponent', label: 'Authors', labelInfo: 'some extra info' },
    ...
    render() {
        ...
        if (!this.isNewVersionForm()) {
            ...
            fields.push(react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", null,
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactDynamicLengthList, { artifactUpdater: this.props.onListChange("authors"), newComponentGenerator: (item, onFieldChange, onDelete) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(ArtifactAuthorComponent, { author: item, onFieldChange: onFieldChange, onDelete: onDelete }), newObjectGenerator: () => ({ full_name: "", email: "", affiliation: "" }), list: [...this.props.artifact.authors] })));
            /**
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.40d1b12b5f90d136fff1.js.map