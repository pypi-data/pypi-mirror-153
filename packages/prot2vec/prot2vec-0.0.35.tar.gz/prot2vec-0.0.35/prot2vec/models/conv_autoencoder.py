...
def get_model(seq_len=24, seq_depth=21, dropout=0.1):
    ...
    # (None, 256)
    embedded = Dense(256, activation=None)(x)
    x = embedded
    x = Dropout(dropout)(x)
    ...
    model = Model(inputs=input_layer, outputs=output_layer, name='conv1D_autoencoder')
